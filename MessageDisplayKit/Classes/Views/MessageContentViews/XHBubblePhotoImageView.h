...
/**
 *
 *  @param messagePhoto      文件图片
 *  @param filePath          文件路径
 *  @param fileUrl    文件服务器URL链接
 *  @param bubbleMessageType 目标消息类型 蒲剑
 */
- (void)configureMessageFile:(UIImage *)messagePhoto filePath:(NSString *)filePath fileUrl:(NSString *)fileUrl onBubbleMessageType:(XHBubbleMessageType)bubbleMessageType;
