...
@property (nonatomic, copy) NSMutableAttributedString *richtext;
 ...
 *  初始化文件附件类型的消息
 *
 *  @param filePath   目标文件在本地地址
 *  @param fileUrl 目标文件在服务器的原图地址
 *  @param sender         发送者
 *  @param date           发送时间
 *
 *  @return 返回Message model 对象
 */
- (instancetype)initWithFile:(UIImage *)photo
