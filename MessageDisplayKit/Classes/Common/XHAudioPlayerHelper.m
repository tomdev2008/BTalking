...
//            AVAudioPlayer *pl = [[AVAudioPlayer alloc] initWithContentsOfURL:[NSURL fileURLWithPath:fileName] error:nil];
            ...
            NSData *stream = [[NSData alloc] initWithContentsOfURL:url options:NSDataReadingMappedIfSafe error:&playerError ];
            AVAudioPlayer *pl = [[AVAudioPlayer alloc] initWithData:stream error:&playerError];
